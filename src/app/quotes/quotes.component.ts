...
export class QuotesComponent implements OnInit {
  ...
  quotes = [
    new Quotes('Fly, if you cant fly run, if you cant run walk,if you cant walk crawl .',
      'Author: Myles Munroe',new Date()),
    new Quotes('Get busy living or get busy dying.Life is not a test till you start failing','Author: Mark claine',
        new Date()),
